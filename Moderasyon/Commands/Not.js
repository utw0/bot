...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  if (!message.member.hasPermission("ADMINISTRATOR") && !message.member.roles.cache.has(ayar.boosterRolu)) return message.reply(`Bu özelliği kullanabilmek için sunucumuzu boostluyor olman gerekiyor.`).then(x => x.delete({timeout: 5000}));;
